  ...
  <div class="cardBodyWrapper">
    ...
    <div class="formInputs">
      <div class="formGroup">
        ...
        <div v-if="formErrors[0]" class="error">
      ...
      <div class="formGroup">
        ...
        <div v-if="formErrors[1]" class="error">
    ...
    <div class="formInputs">
      <div class="formGroup">
        ...
        <div class="formLabel">
          ...
          <div
            v-if="formErrors[3] != 'notValid' && formErrors[3]"
            class="error"
          >
          ...
          <input
            ...
            :class="
              data.billing_email && !formErrors[4]
                ...
                : ''
            "
            v-model.trim="data.billing_email"
            @input="deliveryMail()"
          />
          <div class="labelInput">{{ $t("orderContactForm.email") }}</div>
          <div
            v-if="!checkMail && formErrors[4] != 'notValid' && formErrors[4]"
            class="error"
          >
            {{ $t("formValidation.email") }}
          </div>
