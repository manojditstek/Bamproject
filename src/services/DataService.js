...
class DataService {
  ...
  authHeader() {
   ...
   events(date) {
     return http.get(`/event/v1/organizer/` + process.env.VUE_APP_ORGANIZER_ID + `/event?with=[subcategory,sector,ticket_config.[ticket_discount],occurrence.[ticket_config,timeslot],timeslot,ticket_format]&created_at=2021-09-10;${date}`, {
